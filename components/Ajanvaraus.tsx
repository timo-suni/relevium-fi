...
function Ajanvaraus() {
  return (
    <div>
        <label htmlFor="ajanvaraus_modal" className="btn btn-sm bg-emerald-400 hover:bg-emerald-600 text-neutral-900 hover:text-neutral-200 font-bold">Varaa Aika</label>
        ...
        <div className="modal">
          <div className="modal-box bg-neutral-800 max-w-4xl">
              <div className="flex flex-row justify-between items-center">
                  <h1 className="text-neutral-200 text-2xl font-bold">Ajanvaraus</h1>
