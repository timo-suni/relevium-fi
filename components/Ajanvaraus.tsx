...
function Ajanvaraus() {
  return (
    <div>
        <label htmlFor="ajanvaraus_modal" className="btn btn-sm bg-emerald-400 hover:bg-emerald-600 text-neutral-900 hover:text-neutral-200 font-semibold">Varaa Aika</label>
